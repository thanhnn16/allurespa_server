        ...
        <section>
            <div class="page-header min-vh-100">
                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login.perform') }}">
                                        ...
                                        <div class="flex flex-col mb-3">
                                            <input type="tel" name="phone_number" class="form-control form-control-lg" placeholder="{{ old('phone_number') ?? '0123456789' }}" aria-label="Số điện thoại">
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-1 text-sm mx-auto">
                                        Quên mật khẩu?
                                        <a href="{{ route('reset-password') }}" class="text-primary text-gradient font-weight-bold">Đặt lại mật khẩu</a>
                                    </p>
                                </div>
                            </div>
                        </div>
              ...
              background-size: 250px; background-repeat: no-repeat; background-position: center">
                                ...
                                <p class="text-black-50 position-relative">The more effortless the writing looks, the more

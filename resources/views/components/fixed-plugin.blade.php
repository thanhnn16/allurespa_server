<div class="fixed-plugin">
    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body pt-sm-3 pt-0 overflow-auto">
            <!-- Sidebar Backgrounds -->
            <div>
                <h6 class="mb-0">Màu nền thanh bên</h6>
            </div>
            ...
            <div class="mt-3">
                ...
                <p class="text-sm">Chọn 1 trong 2 kiểu.</p>
            </div>
            <div class="d-flex">
            ...
            <p class="text-sm d-xl-none d-block mt-2">Bạn có thể thay đổi loại thanh điều hướng ngay trên desktop.</p>
            <!-- Navbar Fixed -->
